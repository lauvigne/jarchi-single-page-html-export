...
function getArchiScaleImageExportPreference() {
    var ArchiPluginClass = getArchiJavaType("com.archimatetool.editor.ArchiPlugin");
    var IPreferenceConstantsClass = getArchiJavaType("com.archimatetool.editor.preferences.IPreferenceConstants");
